          ...
          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            --}}
              <div class="modal-body">
                ...
                <input type="text" class="form-control" placeholder="Description ..." name="deskripsi" id="description-input">
                {{--input dropdown--}}
                <select class="form-select" aria-label="Default select example" name="skala_prioritas" id="priority-input">
